<?php
  ...
  function log_in_user($user) {
    // TODO Store user's ID in session (COMPLETED)
    $_SESSION['user_id'] = $user;
    session_regenerate_id();
    $_SESSION['logged_in'] = true;
    // TODO Store last login time in session (COMPLETED)
  ...
  function destroy_current_session() {
    // TODO destroy the session file completely (COMPLETED)
    // using both unset and destroy for compatibility
  ...
  function last_login_is_recent() {
    // TODO add code to determine if last login is recent (COMPLETED)
  ...
  function user_agent_matches_session() {
    // TODO add code to determine if user agent matches session (COMPLETED)
