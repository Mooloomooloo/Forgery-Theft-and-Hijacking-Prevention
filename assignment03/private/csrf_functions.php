<?php
  ...
  // Adds token to user's session data
  ...
  function csrf_token_tag() {
    // TODO needs to set a token and put in an HTML tag (COMPLETED)
  ...
  function csrf_token_is_recent() {
    // TODO add code to determine if csrf token is recent (COMPLETED)
